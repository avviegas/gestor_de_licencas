...
<div class="content">
    <div class="card">
        <div class="card-body">
            ...
            <form action="<?php echo base_url("supplier/update/$supplier->SUPPLIERID"); ?>" method="post"
                ...
                <div class="text-right">
                    <a href="<?php echo base_url("supplier"); ?>" class="btn btn-danger btn-sm font-weight-bold"><i
